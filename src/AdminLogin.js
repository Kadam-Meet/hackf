...
const AdminLogin = () => {
  ...
  const { login } = useAuth(); // Use generic login function
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      if (email === 'admin@example.com' && password === 'password') {
        login('admin'); // Pass the role 'admin'
      ...
      <div className="admin-card">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <div className="password-input-container"> {/* New wrapper for password input and toggle */}
              <input
              ...
              >
                {showPassword ? <FaEyeSlash /> : <FaEye />} {/* Render eye icon based on state */}
              </span>
            </div>
